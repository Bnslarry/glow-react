(function (global, factory) {
	...
	const appendInitialChild = (child, parent) => {
	...
	const commitMutationEffects = (finishedWork) => {
	    ...
	    while (nextEffect !== null) {
	        ...
	        if ((nextEffect.subtrssFlags & MutationMask) !== NoFlags &&
	            child !== null) {
	            nextEffect = child;
	        }
	        else {
	...
	function commitRoot(root) {
	    ...
	    // 判断是否存在3个子阶段需要执行的操作
	    const subtreeHasEffects = (finishedWork.subtrssFlags & MutationMask) !== NoFlags;
